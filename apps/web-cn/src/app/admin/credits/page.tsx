...
interface CreditLog {
    ...
    task_id: string | null;
    amount: number;
    type: 'generation' | 'refund' | 'top-up' | 'adjustment' | 'system_reward';
    description: string;
    created_at: string;
    profiles: {
        display_name: string;
        ...
        <div className="space-y-6">
                ...
                <div className="flex gap-3">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <option value="system_reward">system_reward</option>
                        </select>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-gray-200 dark:border-zinc-800 shadow-sm transition-all hover:scale-[1.01]">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Initial/Top-up credits</p>
                </div>
