...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = `
      ...
      img-src 'self' data: blob: https://cdn.tewan.club https://www.googletagmanager.com https://www.google-analytics.com https://www.tewan.club https://tewan.club https://ui-avatars.com https://*.baidu.com https://*.bdstatic.com;
