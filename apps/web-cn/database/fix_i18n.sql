...
UPDATE wrap_models SET name_en = 'Model 3 2024+' WHERE slug = 'model-3-2024-plus' AND name_en IS NULL;
UPDATE wrap_models SET name_en = 'Model Y' WHERE slug = 'model-y-pre-2025' AND name_en IS NULL;
UPDATE wrap_models SET name_en = 'Model Y 2025+' WHERE slug = 'model-y-2025-plus' AND name_en IS NULL;
